...
OpeningHours _$OpeningHoursFromJson(Map<String, dynamic> json) {
  return OpeningHours(
    ...
    periods: (json['periods'] as List?)?.map((e) => e == null ? null : Period.fromJson(e as Map<String, dynamic>)).toList(),
    weekdayText: (json['weekday_text'] as List?)?.map((e) => e as String).toList(),
  );
}
